...
- **User Input Example:** _“3-bedroom flat in Lekki, max ₦800k/year, ground floor, good security, near a school.”_
- **System Capabilities:**
...
- **Last Name**
- **Phone Number**
- **Describe yourself in a few sentences:** _I currently live in Lugbe and I am looking for an apartment in Maitama._ (Optional)
- **What is your reason for moving?** (Optional)
- **Number of tenants** (Optional)
- **Move-in date:** _As soon as possible_ or _Select a date_
